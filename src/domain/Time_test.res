...
describe("Time.format", () => {
  ...
  test("two-digit minutes are not padded", t =>
    t->expect(Time.format(600000.))->Expect.toBe("10:00.000")
  )
  test("truncates fractional milliseconds", t =>
    t->expect(Time.format(1999.9))->Expect.toBe("0:01.999")
  )
})
